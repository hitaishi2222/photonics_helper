...
pulses = {
    "gaussian": Envelope(
        shape="gaussian", peak_amplitude=1.0, pulse_width=Time(50, "fs")
    ),
    ...
    "triangular": Envelope(
        shape="triangular", peak_amplitude=1.0, pulse_width=Time(50, "fs")
    ),
    "parabolic": Envelope(
        shape="parabolic", peak_amplitude=1.0, pulse_width=Time(50, "fs")
    ),
}
...
for name, pulse in pulses.items():
    ...
    fig.savefig(
        f"examples/images/{name}_2d_matplotlib.png", dpi=300, bbox_inches="tight"
    )
...
fig.savefig(
    "examples/images/chirped_gaussian_2d_matplotlib.png", dpi=300, bbox_inches="tight"
)
