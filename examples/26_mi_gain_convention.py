...
print(f"  solver  : Ω_c = {info['Omega_cutoff']:.4e}, "
...
lam0 = 1550e-9
lam_side = 2 * np.pi * 299792458.0 / (2 * np.pi * 299792458.0 / lam0 + omega_sb[1]) * 1e9
...
ax.grid(alpha=0.3)
plt.tight_layout()
fig.savefig("examples/images/mi_gain_convention.png", dpi=150,
            bbox_inches="tight")
