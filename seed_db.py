...
SELLMEIER_MATERIALS = {
    ...
    "LiNbO3": {
        "form": "standard",
        "a0": 1.0,
        "coefficients": [2.9804, 0.5981, 8.822],
        "wavelengths": [0.02147, 0.08967, 416.08],
        "valid_from_um": 0.4,
        "valid_to_um": 2.0,
        "source": "Edwards & Lawrence, Opt. Quant. Elect. 16, 373 (1984); extraordinary (e-axis), congruent LiNbO3 — default polarity for x-cut χ⁽²⁾ work (d33); ordinary axis in the LiNbO3_or row",
    },
    "LiNbO3_er": {
        "form": "standard",
        "a0": 1.0,
        ...
        "valid_from_um": 0.4,
        "valid_to_um": 2.0,
        "source": "Edwards & Lawrence, Opt. Quant. Elect. 16, 373 (1984); extraordinary ray (e) — canonical LiNbO3 default axis",
    },
    "LiNbO3_or": {
        "form": "standard",
        "a0": 1.0,
        "coefficients": [2.6734, 1.2290, 12.614],
        "wavelengths": [0.01764, 0.05914, 474.60],
        "valid_from_um": 0.4,
        "valid_to_um": 2.0,
        "source": "Edwards & Lawrence, Opt. Quant. Elect. 16, 373 (1984); ordinary ray (o)",
    },
    "YAG": {
        "form": "standard",
        "a0": 4.324876,
